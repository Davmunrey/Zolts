...
- `tests/` — 656 tests, each backing a specific claim made in `docs/`; the 296 runtime tests run against a real Postgres and CI fails a run that skipped them
...
PYTHONPATH=. python3 -m pytest tests/ -q               # 656 tests

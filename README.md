...
- `tests/` — 631 tests, each backing a specific claim made in `docs/`; the 271 runtime tests run against a real Postgres and CI fails a run that skipped them
...
PYTHONPATH=. python3 -m pytest tests/ -q               # 631 tests
